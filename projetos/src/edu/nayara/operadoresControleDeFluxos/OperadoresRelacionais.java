...
public class OperadoresRelacionais {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("i1 != i2 " + (i1 != i2)); //v
        System.out.println("i1 > i2 " + (i1 > i2)); //f
        System.out.println("i1 <= i2 " + (i1 <= i2)); //v
...
//      System.out.println(s1 != s2); // nao se aplica string
//      System.out.println(s1 < s2); // nao se aplica string
